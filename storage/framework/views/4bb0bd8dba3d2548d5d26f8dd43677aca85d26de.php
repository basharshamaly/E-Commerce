...
/>
        ...
        <link rel="stylesheet" href="<?php echo e(asset('extra-assets/ijaboCropTool/ijaboCropTool.min.css')); ?>">
...
?>
			...
			<div class="menu-block customscroll">
				<div class="sidebar-menu">
					<ul id="accordion-menu">
						...
						<li>
							<a href="<?php echo e(route('admin.category.cat-sub-cat-list')); ?>" class="dropdown-toggle no-arrow <?php echo e(Route::Is('admin.category.*')?'active':''); ?>">
                        ...
                        <li>
							<a href="<?php echo e(route('admin.profile')); ?>" class="dropdown-toggle no-arrow <?php echo e(Route::Is('admin.profile') ? 'active':''); ?>">
                        ...
                        <li>
							<a href="<?php echo e(route('admin.settings')); ?>" class="dropdown-toggle no-arrow <?php echo e(Route::Is('admin.settings') ? 'active':''); ?>">
		...
		<script src="/back/vendors/scripts/layout-settings.js"></script>
            ...
            <script src="<?php echo e(asset('extra-assets/ijaboCropTool/jquery.js')); ?>"></script>


            <script src="<?php echo e(asset('extra-assets/ijaboCropTool/ijaboCropTool.min.js')); ?>"></script>
...
<?php /**PATH D:\all think proparite laravel\E-Commerce\e-commerce\resources\views/back/pages/page-layout.blade.php ENDPATH**/ ?>