            ...
            <div class="swiper-slide">
              <div class="banner-item image-zoom-effect">
                <div class="image-holder">
                  <a href="#">
                    <img src="/images/categories/<?php echo e($category->category_image); ?>" alt="product" class="img-fluid">
                  </a>
                </div>
                <div class="banner-content py-4">
                  <h5 class="element-title text-uppercase">
                    <a href="index.html" class="item-anchor"><?php echo e($category->category_name); ?></a>
                  </h5>
...
<?php /**PATH D:\all think proparite laravel\E-Commerce\e-commerce\resources\views/front/layout/inc/header.blade.php ENDPATH**/ ?>